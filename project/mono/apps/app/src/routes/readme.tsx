...
<video src="https://pub-2841a52b911a4219930a8f0eeb5a5550.r2.dev/mobile-demo.mp4" autoplay loop muted playsinline controls style="max-width: 250px; width: 100%; margin: 0 auto;" />
...
Upload a resume or use the demo mode to see JobWizard find job offers (e.g., “Data engineering jobs in France”) and generate a cover letter, like the one below for an Azure Data Engineer role at Devoteam:

> **Sample Cover Letter**  
> Dear Devoteam Hiring Team,  
> I am excited to apply for the Azure Data Engineer position at Devoteam. With over six years of experience in designing scalable data solutions on AWS, I am eager to contribute to your innovative AI-driven projects. At Consumer Reports, I led a migration from Oracle to Redshift, boosting performance by 14% and saving $678,000 annually. My expertise in Spark, PySpark, and cross-functional collaboration aligns with Devoteam’s needs for industrializing data projects on Azure. I am inspired by your “Tech for People” philosophy and am confident my skills in Azure Data Services will support your mission of sustainable digital transformation.  
> Sincerely,  
> Alan Susa
...
export const Route = createFileRoute("/app/readme")({
	component: ReadmePage,
});

function ReadmePage() {
	return (
		<div className="h-full flex flex-col gap-8 w-full overflow-x-hidden">
			<Button className="max-w-[500px] mx-auto w-full" size="sm">
				<Link to="/app/seek">Find Jobs Now</Link>
				<ArrowRight />
			</Button>
			<div className="h-full overflow-y-auto p-8 w-full overflow-x-hidden">
				<article className="prose prose-sm mx-auto h-full w-full break-all">
